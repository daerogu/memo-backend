...
# ── CORS: 허용 출처를 환경변수로 (배포 시 Vercel 주소로) ──  ← 단계 5 변경
origins = os.getenv("ALLOWED_ORIGINS", "http://localhost:5173", "https://memo-backend-yeu0.onrender.com").split(",")
